...
use realorrug_pumpfun::Pool;
use realorrug_pumpfun::curve::Malformed;
use realorrug_pumpfun::token::{MintAccount, Reserve, TokenAccount, TokenMalformed};
...
pub enum Unreadable {
    ...
    /// [`Malformed`](realorrug_pumpfun::curve::Malformed) is a plain data enum with
