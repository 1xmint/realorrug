...
pub struct Entry {
    ...
    pub signals: Option<Vec<realorrug_roast::sheet::Signal>>,
...
mod tests {
    ...
    fn a_line_written_before_the_count_existed_reads_as_unknown_and_not_as_nothing() {
        ...
        assert_eq!(
            entry.signals,
            Some(vec![
                realorrug_roast::sheet::Signal::CreatorBoughtOwnLaunch,
                realorrug_roast::sheet::Signal::LaunchBlockInStrongestBand,
            ])
        );
