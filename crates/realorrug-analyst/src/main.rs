...
//! [`daemon`](realorrug_analyst::daemon), where one poll can be driven by a test
//! against a fake platform rather than only by systemd against the real one.
//!
//! Its caller is `realorrug-analyst.service`. AGENTS.md section 5 asks for a
