...
/// documentation: `crates/realorrug-pumpfun/tests/fixtures/pumpswap_fees.json`
...
/// in `crates/realorrug-pumpfun/tests/the_fee_after_graduation_is_a_ladder.rs` ties
...
mod tests {
    ...
    fn the_program_address_renders_as_the_captured_owner() {
        ...
        // `crates/realorrug-pumpfun/tests/the_fee_after_graduation_is_a_ladder.rs`,
