...
//! [`crate::token`] parses those, and `realorrug_onchain::reserves` reads them
...
///
/// [`the_discriminator_is_the_one_mainnet_uses`]: https://github.com/hey-vera/radar/blob/main/crates/realorrug-pumpfun/tests/the_pool_layout_is_what_mainnet_holds.rs
