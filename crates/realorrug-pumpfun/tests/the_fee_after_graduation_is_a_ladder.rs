...
use realorrug_pumpfun::fees::{FeeConfig, Fees};
...
fn the_program_address_is_the_one_that_owns_the_captured_account() {
    // `realorrug_decode::pumpswap::PROGRAM_ID` is a byte literal, and a byte literal
    ...
    // 2026-09-05 at slot 444,505,829. The constant lives in `realorrug-decode`,
    ...
    assert_eq!(
        owner,
        realorrug_decode::pumpswap::PROGRAM_ID.to_string(),
