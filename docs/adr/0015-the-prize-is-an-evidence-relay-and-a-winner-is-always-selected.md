...
([`scan_ranking`](../../crates/realorrug-analyst/src/contest.rs)), and an entry the
walk never reached keeps `verified: None`, which
[`Metrics::score`](../../crates/realorrug-contest/src/score.rs) resolves to the
...
[`Excluded::AccountAgeUnknown`](../../crates/realorrug-contest/src/score.rs) do not
...
[`crates/realorrug-payout`](../../crates/realorrug-payout) separately establishes a
